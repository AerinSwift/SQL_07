 ...
 * 
 * Берем по одному элементу, даже если имя встречается несколько раз, упорядочиваем по алфавиту
 */
 ...
 * Соединяем таблицы по айди каталога, запрашиваем изделие и соответствующий каталог.
 */
